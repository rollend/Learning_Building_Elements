# -*- coding: utf-8 -*-
"""
Created on Mon Apr 25 11:54:32 2016
...
def main():
    ...
    base_learn = os.getcwd()+"/learn/"
    p = Pool()
    for i in DClasses:
        p.learn(base_learn + i, i)   
    
    base_test = os.getcwd()+"/test/"
    for i in DClasses:
        dir = os.listdir(base_test + i)
        for file in dir:
            res = p.Probability(base_test + i + "/" + file)
